 ...
 * Copyright (c) 2009-2011 by commandPattern, Inc. All Rights Reserved.
...
//@interface commandPatternObject : NSObject
//@end

@interface commandPatternObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[commandPatternObject class]])
		{
			for (NSString *key in [[(commandPatternObject*)o modules] allKeys])
			{

...
/**
 Base class for all commandPattern views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the commandPattern view hierarchy (such as wrapped iOS UIViews) was touched.

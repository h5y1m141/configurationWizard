...
@interface commandPatternObject : KrollCoverageObject {
#else
@interface commandPatternObject : KrollObject {
#endif
@private
...
extern NSString * commandPattern$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	commandPatternObject *_commandpattern;
    KrollObject* console;
	BOOL shutdown;

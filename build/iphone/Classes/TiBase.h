...
// in simulator we redefine to format for commandPattern Developer console
...
{\
	NSString * exceptionName = [@"org.commandpattern." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.commandpattern";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcommandPatternNativeItemNone = -1, 
	UIcommandPatternNativeItemSpinner = -2,
	UIcommandPatternNativeItemProgressBar = -3,
	
	UIcommandPatternNativeItemSlider = -4,
	UIcommandPatternNativeItemSwitch = -5,
	UIcommandPatternNativeItemMultiButton = -6,
	UIcommandPatternNativeItemSegmented = -7,
	
	UIcommandPatternNativeItemTextView = -8,
	UIcommandPatternNativeItemTextField = -9,
	UIcommandPatternNativeItemSearchBar = -10,
	
	UIcommandPatternNativeItemPicker = -11,
	UIcommandPatternNativeItemDatePicker = -12,
	
	UIcommandPatternNativeItemInfoLight = -13,
	UIcommandPatternNativeItemInfoDark = -14,
	
	UIcommandPatternNativeItemDisclosure = -15,
	
	UIcommandPatternNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all commandPattern instances of

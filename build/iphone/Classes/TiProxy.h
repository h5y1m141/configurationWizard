...
//Rare exceptions to indicate a bug in the _commandpattern code (Eg, function that a subclass should have implemented)
...
/**
 The base class for commandPattern proxies.
 */
